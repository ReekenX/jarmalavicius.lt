...
nuo tada kai pradėjau naudoti patį Pomodoro. Turiu virš 7 metus duomenų kuriuos
galiu analizuoti.
...
rezultatai gali būti paprasčiausias pinigai / pelnas / atlyginimas. Šiame
straipsnyje apie tai, kaip Pomodoro man padeda tai pasiekti.
...
* Darbą pradedu 5 ryto (iš tikrųjų).
* Su Toggl Chrome Extension pasileidžiu laikmatį 25 minutėms.
* Dirbu prie vienos užduoties vienu metu. Jokių Facebook, Slack, chatų ar kitų
  socialinių tinklų.
...
pavargs akys, nugara, rankos. Todėl pavaikščioti, atsitraukti - yra labai
svarbu. Ir ne tik per ilgąją pertrauką.

## Darbo biure problemos

Yra labai daug studijų apie „darbą“ darbe ir dar daugiau (nebūtinai pagrįstų)
komentarų ar                           xe
...
Iš patirties atradau, kad tai labai gerai išsprendžia atidėliojimo problemą. Iš
...
## Kitoks laiko intervalas - be pertraukų
...
Turėjau ir viešą profilį su {% include external_link.html url="http://www.tomato.es/users/5073f55fd43b8100020001f4" text="Pomodoro sekimu - Tomato.es" %}.
...
geriau atsispindi rezultatuose.

## Pomodoro technika vaikams

Turiu du vaikus, tačiau Pomodoro su jais dar neeksperimentavau. Tiesa, yra
tikrai ne vienas straipsnis apie tai, kaip ši technika gelbsti į mokyklą
einantiems vaikams.
...
Mano rekomendacija - visada sekti savo pomodoro. Programinės įrangos ta tema -
gausybė. Nesunkiai rasite ką naudoti. Tiek telefone, tiek naršyklėje, tiek
kompiuteryje. Net išmaniam telefonui tikrai rasite programėlę.

Paėmus neilgą (pusmečio) intervalą iš ataskaitų galima pamatyti įvairių įdomių
dalykų.

{% include post_image.html image="/i/2020/tomato_es_dienos.png" text="Nuotrauka iš mano Tomato.es profilio ataskaitos" %}

Iš nuotraukos aukščiau matyti, kad per dieną turėdavau net 11 valandų dienoje
kurioje darbo padarydavau daugiausiai (užregistruodavau daugiausia pomodoro).
...
nuo 4). Manau, kad tai dėl programos laiko juostų skirtumo.
...
padarydavau daugiau. O daugiau padarymas konvertavosi į didesnį pelną.
...
Todėl modernaus (šiuolaikinio) Pomodoro būtinybė - dirbti be trikdžių. Tie kas
dirba prie kompiuterio, turėtų uždaryti visas ne su užduotimi susijusias
...
ginčyjamsi. Yra padaryta tyrimų, kurie sako, kad darbas tyloje yra
produktyvesnis už darbą klausant muzikos per ausines. Net jeigu teorija yra
tokia, praktiškai kai kam tai veikia atvirškčiai. Anksčiau gal kokius 5 metus
...
Visiškams geek'ams galėtų pamatyti [Pomodoro BASH skriptas](/mano-projektai/pomodoro-bash-skriptas) -
